...
if($ischeck == 1)
{
		echo "公司领导查看已经审批";
		$leadercheck=$_SESSION['name'];
        comSelectIsCheckedOrd($leadercheck);
}
...
if($ischeck == 2)
{
		echo "公司领导查看历史订单";
		$leadercheck=$_SESSION['name'];
        comSelectIsCheckedWithHis($leadercheck);
}
?>
	</div>
	...
	<div data-role="footer" data-position="fixed">
		<div data-role="navbar">
			<ul>
				...
				<li><a href="carindex4.php?ischeck=1" data-icon="check" >已批准</a></li>
				<li><a href="carindex4.php?ischeck=0"  data-icon="comment" >待审核</a></li>
				<li><a href="carindex4.php?ischeck=2"  data-icon="check">历史订单</a></li>
			</ul>
		</div>
