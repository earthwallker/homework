	...
	<div data-role="footer" data-position="fixed">
		<div data-role="navbar">
			...
			<!-- 	<li><a href="" data-rel="back" data-icon="back">返回首页</a></li> -->
                <li><a data-ajax="false"  data-icon="check" href="ordstateset.php?msg=pass&type=dpt&id=<?php echo $id?>"> 批准 </a></li>	
                <li><a data-ajax="false"  data-icon="delete" href="ordstateset.php?msg=nopass&type=dpt&id=<?php echo $id?>"> 不批准 </a></li>			
			</ul>
		</div>
