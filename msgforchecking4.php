	...
	<div data-role="footer" data-position="fixed">
		<div data-role="navbar">
			<ul>
                ...
                <li><a data-ajax="false"  data-icon="check" href="ordstateset.php?msg=pass&type=com&id=<?php echo $id?>">批准</a></li>	
                <li><a data-ajax="false"  data-icon="check" href="ordstateset.php?msg=nopass&type=com&id=<?php echo $id?>">不批准</a></li>			
			</ul>
		</div>
